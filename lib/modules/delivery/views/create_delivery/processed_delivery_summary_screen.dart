...
import 'package:gosharpsharp/modules/delivery/views/widgets/delivery_dispute_entry_bottom_sheet.dart';
                    ...
                    child:
                            ...
                            onPressed: () async {
                              ...
                              Get.find<SocketService>().listenForAvailableRiders(
                                onRiderOnline: (data) {
                                  final riders = (data as List)
                                      .map(
                                        (r) => AvailableRiderModel.fromJson(r),
                                      )
                                      .toList();
                              ...
                              ordersController
                                  .drawPolyLineFromOriginToDestination(
                                    context,
                                    originLatitude: selectedDelivery
                                        .pickUpLocation
                                        .latitude,
                                    originLongitude: selectedDelivery
                                        .pickUpLocation
                                        .longitude,
                                    originAddress:
                                        selectedDelivery.pickUpLocation.name,
                                    destinationLatitude: selectedDelivery
                                        .destinationLocation
                                        .latitude,
                                    destinationLongitude: selectedDelivery
                                        .destinationLocation
                                        .longitude,
                                    destinationAddress: selectedDelivery
                                        .destinationLocation
                                        .name,
                                  );
                            },
                        ...
                        ? Column(
                            ...
                            children: [
                              Visibility(
                                visible:
                                    ordersController.selectedDelivery?.rating ==
                                    null,
                                child: CustomButton(
                                  onPressed: () async {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Visibility(
                            visible: !['canceled', 'pending', 'confirmed']
                                .contains(
                                  ordersController.selectedDelivery!.status ??
                                      "",
                                ),
